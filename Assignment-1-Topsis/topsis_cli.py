"""
TOPSIS CLI - Command Line Interface for TOPSIS Analysis
This script can be run directly without installing the PyPI package.
"""
...
def validate_and_prepare_data(args):
    if len(args) != 5:
        ...
        print("Usage: python topsis_cli.py <InputDataFile> <Weights> <Impacts> <OutputResultFileName>")
        sys.exit(1)
...
def topsis(df, weights, impacts):
    """Perform TOPSIS analysis on the data."""
